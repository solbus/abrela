...
class WelcomeDialog(QDialog):
    def __init__(self, parent=None):
        ...
        info_label.setText(
            ...
            "and<br>"
            "<a href=\"https://kinggizzard.bandcamp.com\">https://kinggizzard.bandcamp.com</a>.<br>"
            "It is an unofficial & fan-made choose-your-own-adventure automated MP3 editor, mixer, and player.<br><br>"
            "---<br><br>"
            "Check for updates to <b>albums.json</b> here:<br>"
            "<a href=\"https://github.com/solbus/abrela/blob/main/app/albums.json\">https://github.com/solbus/abrela/blob/main/app/albums.json</a><br>"
            "With the <b>Update Data</b> button, you can overwrite albums.json to get new transitions as they are added,<br>"
            "without needing to update Abrela.<br><br>"
            "---<br><br>"
            "List of albums that currently have at least one custom transition:<br>"
            "<a href=\"https://github.com/solbus/abrela/blob/main/TRANSITIONS.md\">https://github.com/solbus/abrela/blob/main/TRANSITIONS.md</a><br>"
            "If you download these albums, you'll have access to all custom transitions currently available.<br>"
            "The above link also has a track-by-track list of every custom transition currently available.<br><br>"
            "---<br><br>"
            ...
            "<b>1.</b> Download albums from the Bandcamp links above.<br>"
            "--> Bootleggers are free, but consider throwing some $ at the band!<br>"
            ...
            "or for those experimenting with intentions to create physical media with the bootlegger music.<br><br>"
