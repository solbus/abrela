...
class WelcomeDialog(QDialog):
    def __init__(self, parent=None):
        ...
        info_label.setText(
            ...
            "It is an unofficial & fan-made automated MP3 editor, mixer, and player.<br><br>"
            "<b>INPUT:</b> KGLW albums from Bandcamp, and then choose your own series of tracks/transitions.<br>"
            "<b>OUTPUT:</b> A new MP3 file containing your selected playlist, with automatically edited transitions<br>between tracks.<br><br>"
            "---<br><br>"
            "<b>Important:</b> Currently, only unmodified MP3-format albums from Bandcamp are supported.<br>"
            "<b>MP3 320</b> is recommended because Abrela is configured to maintain MP3 320 quality.<br><br>"
            ...
            "If you download these albums, you'll have access to every custom transition currently available.<br>"
            "The above link also lists all transitions currently available, track-by-track.<br><br>"
            "---<br><br>"
            ...
            "- <b>Custom transitions</b> are all defined manually, so future versions will include more of them.<br><br>"
