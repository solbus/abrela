...
class WelcomeDialog(QDialog):
    def __init__(self, parent=None):
        ...
        info_label.setText(
            ...
            "Abrela works with the music of King Gizzard & The Lizard Wizard bootlegger from<br>"
            "<a href=\"https://bootleggizzard.bandcamp.com\">https://bootleggizzard.bandcamp.com</a> and<br>"
            ...
            "<b>1.</b> Download albums from the Bandcamp links above (bootleggers are free, but consider throwing some $ at the band!).<br>"
